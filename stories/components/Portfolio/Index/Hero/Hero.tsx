    ...
    return <div className={styles.main}>
        ...
        <div className={styles.presentation}>
            ...
            <div className={styles.line+" "+styles.profile}>
                <Image alt={"profile-picture"} src={"/profile.png"} width={40} height={40} className={styles.profilePicture}/>
            ...
            <a href={"https://drive.google.com/file/d/1-_4kCuDi_V5K9odDXkmihN3gThERwhgh/view"}
               target="_blank"
